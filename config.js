...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'trendingboss;https://i.imgur.com/EM8ptEO.jpg',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '233',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || ',',
    STICKER_DATA: process.env.STICKER_DATA || "trending",
    BOT_NAME: process.env.BOT_NAME || 'Trending Boss Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Trending Boss bot;https://i.imgur.com/EM8ptEO.jpg' : process.env.AUDIO_DATA,
